...
import { Loader2, Search, ArrowRight, User, AlertCircle, Info } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b px-6 py-4 flex justify-between items-center sticky top-0 z-10">
        <div className="flex items-center gap-2">
          <span className="text-xl font-bold font-display text-slate-900">Clinical<span className="text-primary">Dashboard</span></span>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {(submission.redFlags as string[]).length > 0 && (
                          <span className="flex items-center gap-1 text-xs font-semibold text-red-600 bg-red-50 px-2 py-0.5 rounded">
                            ...
                            {(submission.redFlags as string[]).length} Potential Risk Indicators
                          </span>
                        )}
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      <div className="text-xs text-slate-500 mb-1 uppercase tracking-wide font-medium">AI-Flagged Concern</div>
