    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white relative overflow-hidden">
      ...
      <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-slate-900 font-display">NHS Triage<span className="text-primary">Assistant</span></span>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-lg leading-relaxed">
              Our AI-assisted triage system ensures patients get the right care at the right time. Fast, safe, and reliable.
            </p>
            ...
            <Card className="p-8 border-0 shadow-2xl rounded-3xl bg-white/80 backdrop-blur-sm">
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-4 p-4 rounded-xl bg-blue-50/50 border border-blue-100">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">Clinically Validated</h3>
                    <p className="text-sm text-slate-600">Based on NICE guidelines and clinical protocols.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-green-50/50 border border-green-100">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">Instant Triage</h3>
